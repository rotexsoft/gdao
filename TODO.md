* Add Unit Tests (using a mock implementation using mock objects)

* Look into the possibility of refactoring the Record class to have connected and disconnected record
